...
defineStrings({
  ...
  'goal-item.freq-history-weekly':  ', semaines récentes : {history}',
  'goal-item.freq-history-monthly': ', mois récents : {history}',
  'goal-item.freq-history-met':     'atteint',
  'goal-item.freq-history-partial': 'partiel',
  'goal-item.freq-history-missed':  'manqué',
  ...
  'goal-item.decr-history':        ', semaines récentes : {history}',
  'goal-item.decr-history-clean':  'net',
  'goal-item.decr-history-slipped': '{count} écarts',
  'goal-item.countdown-aria':     '{title}, {pct} % terminé, {days} jours restants',
  ...
  'urgency.tomorrow':     'échéance demain',
  ...
  'upcoming.detail-days-overdue':     '{days} jours de retard',
  'upcoming.detail-missed-count':     '{count} manquant(s)',
  ...
  'filter.deadlines-hidden': 'Repères d’échéance masqués',
  ...
  'goal-dialog.move-section-current':     'Actuelle',
  ...
  'goal-dialog.type-countdown':           'À la date',
  'goal-dialog.type-summary-weekly':            '{target}×/sem.',
  'goal-dialog.type-summary-monthly':           '{target}×/mois',
  'goal-dialog.type-summary-decreasing-week':   'Éviter, {target} écart/sem. autorisé',
  'goal-dialog.type-summary-decreasing-4weeks': 'Éviter, {target} écart/4 sem. autorisé',
  'goal-dialog.type-summary-countdown':         'À la date',
  ...
  'goal-dialog.target-label-decreasing': 'Écarts autorisés',
  'goal-dialog.allowance-period-week':   'par semaine',
  'goal-dialog.allowance-period-4weeks': 'par 4 semaines',
  'goal-dialog.start-mode-yearstart':    'Début d’année',
  'goal-dialog.start-date-label':        'Date de début',
  'goal-dialog.tracking-summary-prefix-percentage':  'P : ',
  'goal-dialog.tracking-summary-prefix-weekly':      'F : ',
  'goal-dialog.tracking-summary-prefix-days':        'J : ',
  'goal-dialog.tracking-summary-prefix-decreasing':  'É : ',
  'goal-dialog.tracking-summary-prefix-countdown':   'À : ',
  'goal-dialog.tracking-summary-percentage':        '{percent} % terminé',
  'goal-dialog.tracking-summary-weekly':             '{count} sur {target}/semaine à {percent} %',
  'goal-dialog.tracking-summary-monthly':            '{count} sur {target}/mois à {percent} %',
  'goal-dialog.tracking-summary-days-suffix':        'à {percent} %',
  ...
  'day-strip.state-missed':               'manqué',
  'day-strip.state-success':              'enregistré',
  'day-strip.state-unscheduled':          'enregistré, non prévu',
  'day-strip.state-pending':              'prévu',
  'day-strip.state-blank':                'non prévu',
  'goal-dialog.reminder-days-label':      'Jours prévus',
  'goal-dialog.reminder-day-mon':         'L',
  'goal-dialog.reminder-day-tue':         'M',
  'goal-dialog.reminder-day-wed':         'M',
  'goal-dialog.reminder-day-thu':         'J',
  'goal-dialog.reminder-day-fri':         'V',
  'goal-dialog.reminder-day-sat':         'S',
  'goal-dialog.reminder-day-sun':         'D',
  'goal-dialog.reminder-any':             'x',
  ...
  'year-header.color-stone':     'Pierre',
  ...
  'year-header.reflection':          'Bilan annuel',
  'year-header.reflection-add':     'Ajouter',
  'year-header.reflection-score':   '★ {score}',
  'year-header.reflection-saved':   'Bilan enregistré',

  'reflection.dialog-heading':      "Bilan de l'année",
  'reflection.highlights-label':       'Faits marquants',
  'reflection.highlights-placeholder': 'Ce qui a marqué cette année…',
  'reflection.star-aria':           '{n} sur 5 étoiles',
  'reflection.close':               'Fermer',
  'reflection.show':                'Afficher',
  'reflection.hide':                'Masquer',
  'reflection.aspect-people-label':       'Relations',
  'reflection.aspect-people-hint':        'Famille, amis, vie amoureuse, vie sociale',
  'reflection.aspect-people-abbr':        'Re',
  'reflection.aspect-health-label':       'Santé',
  'reflection.aspect-health-hint':        'Physique, mentale, émotionnelle, environnementale, spirituelle',
  'reflection.aspect-health-abbr':        'Sa',
  'reflection.aspect-wealth-label':       'Finances',
  'reflection.aspect-wealth-hint':        'Actuelle, à venir, planifiée, sécurité, liberté',
  'reflection.aspect-wealth-abbr':        'Fi',
  'reflection.aspect-contribution-label': 'Contribution',
  'reflection.aspect-contribution-hint':  'Travail, bénévolat, création, mécénat, enseignement, innovation',
  'reflection.aspect-contribution-abbr':  'Co',
  'reflection.aspect-wonder-label':       'Émerveillement',
  'reflection.aspect-wonder-hint':        "Plaisir, exploration, créativité, aventure, apprentissage, centres d'intérêt",
  'reflection.aspect-wonder-abbr':        'Ém',
  'reflection.card-aspect-summary':       '{label} {value}',
  ...
  'list-detail.bulk-clear-dates':   'Effacer les échéances',
  ...
  'list-detail.archive-btn':             'Archiver',
  'list-detail.unarchive-btn':           'Désarchiver',
  ...
  'list-detail.bulk-clear-dates-toast': 'Échéance effacée pour {n} éléments',
  ...
  'settings.notifications-hint': 'Les notifications ne se déclenchent que lorsque l’application est visible.',
  ...
  'export-sheet.reflection': 'Bilan annuel',
  ...
  'goal-dialog.back-to-edit':            'Modifier',
  'modal-dialog.tab-label':              'Page {index} sur {count}',

  'goal-analytics.page-title-score':      'Score',
  'goal-analytics.page-title-activity':   'Activité',
  'goal-analytics.page-title-streaks':    'Séries',

  'goal-analytics.unit-week':            'semaine',
  'goal-analytics.unit-week-plural':     'semaines',
  'goal-analytics.unit-month':           'mois',
  'goal-analytics.unit-month-plural':    'mois',

  'goal-analytics.stat-slips':           'écarts',
  'goal-analytics.stat-updates':         'mises à jour',
  'goal-analytics.stat-entries':         'entrées',
  ...
  'goal-analytics.pace-behind':       '≈{monthsLabel} de retard — projeté {projected} pour une échéance au {deadline}.',
  'goal-analytics.pace-ahead':        '≈{monthsLabel} d’avance — projeté {projected}.',
  'goal-analytics.pace-projected':    'Au rythme actuel, ~100 % vers {projected}.',
  'goal-analytics.month-singular':    '1 mois',
  'goal-analytics.month-plural':      '{n} mois',

  'goal-analytics.score-contribute':     '{label} contribuent à',
  'goal-analytics.now':                  'maint.',
  'goal-analytics.older-periods-note':   'Les semaines plus anciennes apparaîtront ici',
  ...
  'goal-analytics.a11y-calendar': 'Carte de chaleur des jours enregistrés sur l’année écoulée',
  'goal-analytics.a11y-freqgrid': 'Grille de fréquence des entrées par jour de la semaine et par mois',
  'goal-analytics.a11y-score-grid': 'Grille des résultats par période contribuant au score',
  'goal-analytics.page-title-overview': 'Aperçu',
  'goal-analytics.consistency-title': 'Régularité',
  'goal-analytics.consistency-note-avg': 'Chaque barre est la moyenne des périodes qu’elle contient, chacune plafonnée à 100 %.',
  'goal-analytics.quarter-prefix':    'T',
  'goal-analytics.timeframe-label':   'Période',
